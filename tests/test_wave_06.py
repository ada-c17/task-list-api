...
# check post task id , task not found, 404
def test_post_task_ids_to_goal_without_a_task(client, one_goal, three_tasks):
    # Act
    response = client.post("/goals/1/tasks", json={
        "task_ids": [13]
    })
    ...
    assert response_body ==  {'message': 'Task 13 is not found'}
