...
def get_all_tasks():
    ...
    # I don't understand why all of the tests pass without line 13 after adding lines 15 ~ 20
    ...
    # Original code that I wrote for wave 1, before adding lines 15 ~ 20 + line 13
    # if title_query:
